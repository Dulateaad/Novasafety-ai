...
import { normalizePerformerReplacements } from '../types/performerReplacement'
...
export function migratePermit(p: Permit): Permit {
  ...
  const next: Permit = {
    ...
    performerReplacements: normalizePerformerReplacements(incoming.performerReplacements),
  }
