...
export const ru: Locale = {
  ...
  notificationEmail: {
    ...
    adminHint:
      'Только администратор задаёт почту для уведомлений всем участникам (включая работников). Для логинов @nova.local укажите реальный email.',
    adminColName: 'ФИО',
    adminColRole: 'Роль',
    adminColLogin: 'Логин',
  ...
  pages: {
    ...
    permissionsSubmit: 'Отправить и подписать',
    permissionsSubmitting: 'Подготовка…',
