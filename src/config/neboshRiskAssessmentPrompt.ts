...
- Титул + блок: объект, дата, заказчик, пересмотр, подрядчик, стандарт
...
- Исходный/остаточный риск задаётся только полями В/Т в таблице. Не пиши в тексте мер, residualNote и описаниях слова low/medium/high и не ставь их в скобках: (low), (medium), (high).
